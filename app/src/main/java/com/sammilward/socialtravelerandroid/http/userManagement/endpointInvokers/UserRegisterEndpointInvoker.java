...
public class UserRegisterEndpointInvoker {
    private OkHttpClient client  = new OkHttpClient();
    private Gson gson = new Gson();
    private MediaType JSON = MediaType.parse("application/json");

    public void PrepareCreateUserPost(String accessToken, CreateUserRequest userRegisterRequest, Callback callback){
        ...
        String json = gson.toJson(userRegisterRequest);
